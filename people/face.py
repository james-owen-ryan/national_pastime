...
class Face(object):
    ...
    def __str__(self):
        ...
        return "Face of {}".format(self.person.name)
    ...
    def __init__(self, face):
        ...
        if self.face.person.biological_mother:
            ...
            if parent_skin_color_tuple[0] == parent_skin_color_tuple[1]:
                ...
                skin_color = (
                    self.face.person.cosmos.config.child_skin_color_given_parents[parent_skin_color_tuple]
                )
            self.color = Feature(
...
class Eyebrows(object):
    ...
    def __init__(self, face):
        ...
        if random.random() < self.face.person.cosmos.config.chance_eyebrows_are_same_color_as_hair:
