...
# TODO  IT APPEARS THAT AT LEAST 'CONCEIVED_BY' ISN'T WORKING CORRECTLY; ALSO
# TODO  WHERE IS 'NAMED_FOR'?
...
class Name(str):
    ...
    def __init__(self, value, progenitor, conceived_by=(), derived_from=()):
        ...
        @param progenitor: The Player with whom this name originates; if this is a hyphenated surname,
                           the progenitor will be the first child to whom it is given.
        @param conceived_by: The Player(s) who conceived of this name; if it's a forename, this will
